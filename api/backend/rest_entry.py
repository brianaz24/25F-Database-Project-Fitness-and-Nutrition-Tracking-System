...
def create_app():
    ...
    from .ngos.ngo_routes import ngos
    from .meals.meal_routes import meals
    from .workouts.workout_routes import workouts
    from .clients.client_routes import clients
    from .plans.plan_routes import plans
